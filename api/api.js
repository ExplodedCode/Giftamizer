...
(async function () {
	...
	var giftConnection = mysql.createConnection({
		host: 'azure.trowbridge.tech',
		user: 'giftamizer', //ALTER USER 'giftamizer'@'localhost' IDENTIFIED WITH mysql_native_password BY 'dP2JzT2eDyF*iRAgVRwp'
		password: 'dP2JzT2eDyF*iRAgVRwp',
	});
