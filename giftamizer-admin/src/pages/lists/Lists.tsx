		...
		<>
			...
			<Box component='main' sx={{ flex: 1, py: { xs: 1, sm: 4, md: 6 }, px: { xs: 1, sm: 2, md: 4 } }}>
				...
				>
					...
					<Box>
						<ListsTable paginationModel={paginationModel} setPaginationModel={setPaginationModel} search={search} setSearch={setSearch} sorting={sorting} setSorting={setSorting} />
					</Box>
				</Paper>
			</Box>
		</>
