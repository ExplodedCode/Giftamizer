const synonyms = {
	...
	PauseCircleFilled: 'controls music video wait status pending',
	PauseCircleOutline: 'controls music video wait status pending',
	PausePresentation: 'device screen share wait status pending',
