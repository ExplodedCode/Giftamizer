...
import { TCustomControl } from './MUIRichTextEditor/Toolbar';
...
const clearInlineStyles = (editorState: EditorState, customStyles?: DraftStyleMap): ContentState => {
	...
	return styles.reduce((newContentState: ContentState, style: string) => Modifier.removeInlineStyle(newContentState, editorState.getSelection(), style), editorState.getCurrentContent());
};
